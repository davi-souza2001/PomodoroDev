...
export function Login() {
	...
	return (
		<div className='h-screen w-screen flex items-center justify-start flex-col xl:flex-row'>
			{loginArea ?
				<>
					<div className='h-60 w-screen flex items-center justify-center font-semibold text-5xl'>
						<span>Let's you in</span>
					</div>
					<div className='h-60 w-screen flex items-center justify-start flex-col'>
						<div
						...
						>
							...
							<button className='ml-3'>Continue with Github</button>
						</div>
					</div>
				</>
				:
			...
			<div className='h-36 w-screen flex items-center justify-center xl:h-screen xl:flex-col'>
				<div className={`hidden ${!loginArea && 'xl:flex'} h-44 w-full items-center justify-center font-semibold text-3xl p-5`}>
					<span>Your Perfect Pomodoro for Planning your activities</span>
				</div>
				<button
